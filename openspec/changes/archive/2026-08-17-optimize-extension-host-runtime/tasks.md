...
- [x] 4.4 Run the extension-coordination and repository-indexing feature roots independently and complete the Rust unit, lint, format, locked-build, and package-build gates
